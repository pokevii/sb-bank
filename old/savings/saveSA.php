<html lang="en-US">
    <head>
        <title>ABC Bank - New Savings Account</title>
    ...
    <nav>
        ...
        <?php
            ...
            $sql = "INSERT INTO savings (Acct_no, lastname, firstname, address, email, phone, balance, date, TRansID, interest_rate, total_amount)
