<html lang="en-US">
    <head>
        <title>ABC Bank - Update Checking Account</title>
    ...
    <nav>
        ...
        <?php
            ...
            if($conn->query($sql) === TRUE) {
                echo "<p>Account updated successfully. <a href=checking.html>Return</a></p>";
            } else {
                echo "<p>Error updating account information. <a href=checking.html>Return</a></p>";
            }
        ?>
    </body>
</html>