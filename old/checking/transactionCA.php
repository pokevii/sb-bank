    ...
    <body>
        <?php
            ...
            if($type == 'deposit')
            {
                $body =
                "
                <form name=\"deposit\" method=\"post\" action=\"depositCA.php\">
                ...
                $body = 
                "
                <form name=\"withdraw\" method=\"post\" action=\"withdrawCA.php\">
                    <label name=\"amount\">Amount to Withdraw:</label>
                    <input type=\"number\" name=\"amount\"><br>
                ...
                $body = 
                "
                <form name=\"deposit\" method=\"post\" action=\"transferCA.php\">
                    <div class=\"note\">This is the account you're transferring funds FROM.
                    <label name=\"T_Acct_no\">Transfer Account Number:</label>
                    <input type=\"number\" name=\"T_Acct_no\"><br>

                    <label name=\"amount\">Amount to Transfer:</label>
                    <input type=\"number\" name=\"amount\"><br>
