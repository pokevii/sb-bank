<html lang="en-US">
    ...
    <body>
        <?php
            ...
            $sql = "SELECT * FROM checking WHERE `Acct_no`='$T_Acct_no'";
            $result = $conn->query($sql);
            ...
            $sql = "UPDATE checking SET Balance=$new_account_balance WHERE Acct_No=$Acct_no";
            $result = $conn->query($sql);

            $sql = "UPDATE checking SET Balance=$new_transfer_balance WHERE Acct_No=$T_Acct_no";
            $result = $conn->query($sql);
